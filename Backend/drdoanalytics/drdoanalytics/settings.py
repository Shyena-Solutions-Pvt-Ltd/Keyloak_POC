...
SECRET_KEY = 'django-insecure-75l8p*1#$dw1vny75)o!%u!)v*h30be#z=e9i4r7l*axdsyyd!'
...
MIDDLEWARE = [
    'authorization.auth_middleware.AuthMiddleware',
...
ROOT_URLCONF = 'drdoanalytics.urls'
...
WSGI_APPLICATION = 'drdoanalytics.wsgi.application'
